function CaseStudiesCard() {
  return (
    <div className="relative">
      <div className="sticky top-[80px] rounded-lg bg-[#3a3c7e] p-5 md:p-10 flex flex-col">
        ...
        <p className="mb-[10px] text-center text-white">
          Let Edstellar handle your organizations training needs. Focus on your
          business while we support your growth.
        </p>
