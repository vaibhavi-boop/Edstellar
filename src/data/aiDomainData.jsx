...
export const methodSection = {
  ...
  stages: [
    { ix: "01", t: "Discover", over: "Map current capability against <b>role-based benchmarks</b>.", p: "We meet your CTO and L&D team to baseline what your data, engineering and product people can actually do today, against the roles you need them to fill. The output is a prioritized skill-gap report with objectives tied to business outcomes rather than course completions.", mods: "Week 1-2", does: ["Role and capability mapping across teams", "Prioritized skill-gap report", "Objectives agreed with the budget holder"] },
    { ix: "02", t: "Design", over: "Build a curriculum around <b>your stack and obligations</b>.", p: "Programs are assembled against your model stack, your data, and the governance regime you operate under, then trainers are shortlisted from the vetted bench. Nothing is pulled off a shelf; the discovery output determines what the cohort actually covers.", mods: "Week 2-4", does: ["Curriculum mapped to roles and frameworks", "Trainer shortlist with domain match", "Trial session before you commit"] },
    { ix: "03", t: "Deliver", over: "Run it live, <b>on-site or virtual</b>, with labs.", p: "Closed-cohort instructor-led sessions in your language and timezone, with GPU sandboxes, notebooks and retrieval or agent environments shipped alongside. No self-paced modules and no recorded substitutes.", mods: "Scheduled to your calendar", does: ["Instructor-led, closed cohort", "Hands-on labs with every session", "On-site, virtual or blended"] },
    { ix: "04", t: "Assess", over: "Measure the <b>skills delta</b>, not attendance.", p: "Pre and post technical assessments establish a measurable change in capability, benchmarked against role frameworks. Lab performance and applied outcomes are reported alongside, so the result is defensible to a board rather than a completion certificate.", mods: "Immediately after delivery", does: ["Pre and post competency assessment", "Lab and applied-task benchmarks", "Post-program report for leadership"] },
    { ix: "05", t: "Sustain", over: "Keep the capability <b>in use and current</b>.", p: "Retrospectives, refresher modules and skill-refresh tracking keep the investment from decaying, and the measured gaps feed the next cycle. AI tooling moves quickly enough that a one-off program is a depreciating asset.", mods: "Quarterly", does: ["Refresher and update modules", "Skill-refresh tracking over time", "Gap map for the next cycle"] },
  ],
};
