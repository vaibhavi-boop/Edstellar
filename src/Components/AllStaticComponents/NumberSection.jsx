    ...
    <section className="bg-white">
      <div className="container">
        ...
        <div className="mx-auto mb-10 max-w-[800px] text-center">
          ...
          <p className="text-[16px] leading-6 text-[#454545]">
            {data.subheading}
          </p>
        </div>
        ...
        <div className="hidden lg:block">
          <div className="relative mt-12">
            {/* Horizontal Line */}
            <div className="absolute left-0 right-0 top-[24px]">
              ...
              {data.steps.map((step) => {
                ...
                return (
                  ...
                  >
                    {/* Circle */}
                    <div
                      className="relative z-10 mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#2A2F68] text-[22px] font-bold text-white transition-all duration-300 group-hover:bg-[#D3E41B] group-hover:text-[#2A2F68]"
                    >
                      {step.number}
                    </div>
                    ...
                    {/* Content */}
                    <div className="mt-5">
                      <h3 className="mb-2 text-center text-[20px] font-bold text-[#3A3A3A]">
                        {step.title}
                      </h3>

                      <p className="mb-4 text-center text-[16px] leading-7 text-[#333]">
                        {step.description}
                      </p>
        ...
        <div className="lg:hidden">
          <div className="relative">
            <div className="absolute bottom-0 left-[18px] top-0 w-[2px] bg-[#03307d80]" />

            <div className="flex flex-col gap-2 md:gap-3 lg:gap-10">
              {data.steps.map((step) => {
                const week = step.week?.trim();
                const badge = step.badge?.trim();
                const points =
                ...
                return (
                  ...
                  >
                    <div
                      className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#2A2F68] text-[18px] font-bold text-white transition-all duration-300 group-hover:bg-[#D3E41B] group-hover:text-[#2A2F68]"
                    >
                      {step.number}
                    </div>

                    <div className="flex-1">
                      <h3 className="mb-2 text-[20px] font-bold text-[#3A3A3A]">
                        {step.title}
                      </h3>
        ...
        {data.highlight && (
          <div className="mx-auto mt-10 max-w-[900px] rounded-xl bg-[#2A2F68] p-5 lg:p-6">
            <div className="flex flex-col gap-2.5 lg:gap-5 items-start md:flex-row">
              {/* Icon */}
