    ...
    <section id="curriculum" className="py-28 border-b border-[var(--rule)]">
      <div className="container">
        ...
        <div className="text-[11px] tracking-[0.24em] uppercase text-[var(--muted)] mb-8 flex items-baseline gap-3 [font-family:var(--mono)]">
          <span className="[font-family:var(--serif)] text-[16px] text-[var(--ink)]">V</span>
        ...
        <p className="text-[var(--muted)] text-[clamp(15px,1.2vw,17px)] leading-[1.7] mb-8 max-w-[64ch]">
          Filter by what your team needs most, open any module for the detail,
          then build an agenda to send with your quote request.
        </p>
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
          <div className="bg-[var(--navy)] text-white rounded-full px-6 py-4 flex items-center gap-5 shadow-[0_20px_60px_-10px_rgba(10,22,40,0.6)] [font-family:var(--mono)]">
            <span className="text-[13px] tracking-[0.06em]">
              ...
              <span className="text-white/40 mx-2">·</span>~{estHrs} hrs of
              16–24
            </span>
            <button
